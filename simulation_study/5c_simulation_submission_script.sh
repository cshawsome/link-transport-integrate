...
R CMD BATCH --no-save --no-restore "--args scenario_num=$SGE_TASK_ID num_replicates=10"  /u/home/c/cshaw343/RScripts/simulation_run.R /u/home/c/cshaw343/link_transport_integrate/output/output.$JOB_ID.$SGE_TASK_ID
echo R CMD BATCH --no-save --no-restore \'--args scenario_num=$SGE_TASK_ID num_replicates=10 \'  /u/home/c/cshaw343/RScripts/simulation_run.R /u/home/c/cshaw343/link_transport_integrate/output/output.$JOB_ID.$SGE_TASK_ID
